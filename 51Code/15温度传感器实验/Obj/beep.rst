      ...
      000000                        265 	.ds 8
                                    ...
                                    327 	.area CSEG    (CODE)
                                    328 ;------------------------------------------------------------
                                    329 ;Allocation info for local variables in function 'beep'
                                    330 ;------------------------------------------------------------
                                    331 ;time                      Allocated to registers 
                                    332 ;------------------------------------------------------------
                                    333 ;	beep.c:3: void beep(u8 time){
                                    334 ;	-----------------------------------------
                                    335 ;	 function beep
                                    336 ;	-----------------------------------------
      0003BF                        337 _beep:
                           ...
                           000001   344 	ar1 = 0x01
                           000000   345 	ar0 = 0x00
      0003BF AF 82            [24]  346 	mov	r7,dpl
                                    347 ;	beep.c:4: while (time--)
      0003C1                        348 00101$:
      0003C1 8F 06            [24]  349 	mov	ar6,r7
      0003C3 1F               [12]  350 	dec	r7
      0003C4 EE               [12]  351 	mov	a,r6
      0003C5 60 16            [24]  352 	jz	00103$
                                    353 ;	beep.c:6: BEEP = 1;
                                    354 ;	assignBit
      0003C7 D2 A5            [12]  355 	setb	_P2_5
                                    356 ;	beep.c:7: delay_10us(190);
      0003C9 90 00 BE         [24]  357 	mov	dptr,#0x00be
      0003CC C0 07            [24]  358 	push	ar7
      0003CE 12 03 AD         [24]  359 	lcall	_delay_10us
                                    360 ;	beep.c:8: BEEP=0;
                                    361 ;	assignBit
      0003D1 C2 A5            [12]  362 	clr	_P2_5
                                    363 ;	beep.c:9: delay_10us(10);
      0003D3 90 00 0A         [24]  364 	mov	dptr,#0x000a
      0003D6 12 03 AD         [24]  365 	lcall	_delay_10us
      0003D9 D0 07            [24]  366 	pop	ar7
      0003DB 80 E4            [24]  367 	sjmp	00101$
      0003DD                        368 00103$:
                                    369 ;	beep.c:12: BEEP=0;
                                    370 ;	assignBit
      0003DD C2 A5            [12]  371 	clr	_P2_5
                                    372 ;	beep.c:13: }
      0003DF 22               [24]  373 	ret
                                    374 	.area CSEG    (CODE)
                                    375 	.area CONST   (CODE)
                                    376 	.area XINIT   (CODE)
