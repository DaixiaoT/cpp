      ...
      000389                        341 _delay_ms:
                           ...
                           000001   348 	ar1 = 0x01
                           000000   349 	ar0 = 0x00
      000389 AE 82            [24]  350 	mov	r6,dpl
      00038B AF 83            [24]  351 	mov	r7,dph
                                    352 ;	public.c:12: for (i = ms; i > 0; i--)
      00038D                        353 00106$:
      00038D EE               [12]  354 	mov	a,r6
      00038E 4F               [12]  355 	orl	a,r7
      00038F 60 1B            [24]  356 	jz	00108$
                                    357 ;	public.c:14: for(j=110; j>0; j--);
      000391 7C 6E            [12]  358 	mov	r4,#0x6e
      000393 7D 00            [12]  359 	mov	r5,#0x00
      000395                        360 00104$:
      000395 EC               [12]  361 	mov	a,r4
      000396 24 FF            [12]  362 	add	a,#0xff
      000398 FA               [12]  363 	mov	r2,a
      000399 ED               [12]  364 	mov	a,r5
      00039A 34 FF            [12]  365 	addc	a,#0xff
      00039C FB               [12]  366 	mov	r3,a
      00039D 8A 04            [24]  367 	mov	ar4,r2
      00039F 8B 05            [24]  368 	mov	ar5,r3
      0003A1 EA               [12]  369 	mov	a,r2
      0003A2 4B               [12]  370 	orl	a,r3
      0003A3 70 F0            [24]  371 	jnz	00104$
                                    372 ;	public.c:12: for (i = ms; i > 0; i--)
      0003A5 1E               [12]  373 	dec	r6
      0003A6 BE FF 01         [24]  374 	cjne	r6,#0xff,00133$
      0003A9 1F               [12]  375 	dec	r7
      0003AA                        376 00133$:
      0003AA 80 E1            [24]  377 	sjmp	00106$
      0003AC                        378 00108$:
                                    379 ;	public.c:16: }
      0003AC 22               [24]  380 	ret
                                    381 ;------------------------------------------------------------
                                    ...
                                    389 ;	-----------------------------------------
      0003AD                        390 _delay_10us:
      0003AD AE 82            [24]  391 	mov	r6,dpl
      0003AF AF 83            [24]  392 	mov	r7,dph
                                    393 ;	public.c:26: while (ten_us--)
      0003B1                        394 00101$:
      0003B1 8E 04            [24]  395 	mov	ar4,r6
      0003B3 8F 05            [24]  396 	mov	ar5,r7
      0003B5 1E               [12]  397 	dec	r6
      0003B6 BE FF 01         [24]  398 	cjne	r6,#0xff,00111$
      0003B9 1F               [12]  399 	dec	r7
      0003BA                        400 00111$:
      0003BA EC               [12]  401 	mov	a,r4
      0003BB 4D               [12]  402 	orl	a,r5
      0003BC 70 F3            [24]  403 	jnz	00101$
                                    404 ;	public.c:28: }
      0003BE 22               [24]  405 	ret
                                    406 	.area CSEG    (CODE)
                                    407 	.area CONST   (CODE)
                                    408 	.area XINIT   (CODE)
