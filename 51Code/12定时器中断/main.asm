...
;	main.c:7: }
	sjmp	00102$
;------------------------------------------------------------
;Allocation info for local variables in function 'time0'
;------------------------------------------------------------
;i                         Allocated with name '_time0_i_65536_48'
;------------------------------------------------------------
;	main.c:9: void time0() __interrupt 1 //定时器0中断函数
;	-----------------------------------------
;	 function time0
;	-----------------------------------------
_time0:
	push	acc
	push	psw
;	main.c:12: TH0=0XFC;   //给定时器赋初值，定时1ms
	mov	_TH0,#0xfc
;	main.c:13: TL0=0X18;
	mov	_TL0,#0x18
;	main.c:14: i++;
	inc	_time0_i_65536_48
	clr	a
	cjne	a,_time0_i_65536_48,00109$
	inc	(_time0_i_65536_48 + 1)
00109$:
;	main.c:15: if(i==1000){
	mov	a,#0xe8
	cjne	a,_time0_i_65536_48,00103$
	mov	a,#0x03
	cjne	a,(_time0_i_65536_48 + 1),00103$
;	main.c:16: i=0;
	clr	a
	mov	_time0_i_65536_48,a
	mov	(_time0_i_65536_48 + 1),a
;	main.c:17: LED1=!LED1;
	cpl	_P2_0
00103$:
;	main.c:19: }
