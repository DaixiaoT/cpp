...
;	../common.h:9: u8 gsmg_code[17]={0x3f, 0x06, 0x5b, 0x4f, 0x66, 0x6d,
	mov	_gsmg_code,#0x3f
...
;------------------------------------------------------------
;	../common.h:17: void delay_10us(u16 ten_us){
;	-----------------------------------------
;	 function delay_10us
;	-----------------------------------------
_delay_10us:
...
;	-----------------------------------------
_main:
;	main.c:4: SMG_A_DP_PORT = gsmg_code[0];
	mov	_P0,_gsmg_code
;	main.c:5: SMG_A_DP_PORT = gsmg_code[3];
	mov	_P0,(_gsmg_code + 0x0003)
;	main.c:6: while(1){
00102$:
;	main.c:9: }
	sjmp	00102$
