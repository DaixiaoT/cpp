...
;	main.c:7: }
	sjmp	00102$
;------------------------------------------------------------
;Allocation info for local variables in function 'exti0'
;------------------------------------------------------------
;	main.c:8: void exti0() __interrupt 0//外部中断0中断函数
;	-----------------------------------------
;	 function exti0
;	-----------------------------------------
_exti0:
	...
	push	psw
	mov	psw,#0x00
;	main.c:10: delay_10us(1000);//消抖
	mov	dptr,#0x03e8
	lcall	_delay_10us
;	main.c:11: if(KEY3==0){//再次判断K3键是否按下
	jb	_P3_2,00103$
;	main.c:12: LED1=!LED1;//LED1状态翻转
	cpl	_P2_0
00103$:
;	main.c:14: }
	pop	psw
