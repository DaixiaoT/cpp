      ...
      000003 02 00 62         [24]  300 	ljmp	_main
                                    ...
                                    308 ;------------------------------------------------------------
                                    309 ;a                         Allocated to registers r6 r7 
                                    310 ;------------------------------------------------------------
                                    311 ;	main.c:6: int main(void){
                                    312 ;	-----------------------------------------
                                    313 ;	 function main
                                    314 ;	-----------------------------------------
      000062                        315 _main:
                           ...
                           000001   322 	ar1 = 0x01
                           000000   323 	ar0 = 0x00
                                    324 ;	main.c:8: while(1){
      000062                        325 00108$:
                                    326 ;	main.c:9: LSA = 0;
                                    327 ;	assignBit
      000062 C2 95            [12]  328 	clr	_P1_5
                                    329 ;	main.c:10: LSB = 0;
                                    330 ;	assignBit
      000064 C2 96            [12]  331 	clr	_P1_6
                                    332 ;	main.c:11: LSC = 0;
                                    333 ;	assignBit
      000066 C2 97            [12]  334 	clr	_P1_7
                                    335 ;	main.c:12: Led10 = 0;
                                    336 ;	assignBit
      000068 C2 87            [12]  337 	clr	_P0_7
                                    338 ;	main.c:14: while(a--);
      00006A 7E 50            [12]  339 	mov	r6,#0x50
      00006C 7F C3            [12]  340 	mov	r7,#0xc3
      00006E                        341 00101$:
      00006E 8E 04            [24]  342 	mov	ar4,r6
      000070 8F 05            [24]  343 	mov	ar5,r7
      000072 1E               [12]  344 	dec	r6
      000073 BE FF 01         [24]  345 	cjne	r6,#0xff,00133$
      000076 1F               [12]  346 	dec	r7
      000077                        347 00133$:
      000077 EC               [12]  348 	mov	a,r4
      000078 4D               [12]  349 	orl	a,r5
      000079 70 F3            [24]  350 	jnz	00101$
                                    351 ;	main.c:15: Led10 = 1;
                                    352 ;	assignBit
      00007B D2 87            [12]  353 	setb	_P0_7
                                    354 ;	main.c:17: while(a--);
      00007D 7E 50            [12]  355 	mov	r6,#0x50
      00007F 7F C3            [12]  356 	mov	r7,#0xc3
      000081                        357 00104$:
      000081 8E 04            [24]  358 	mov	ar4,r6
      000083 8F 05            [24]  359 	mov	ar5,r7
      000085 1E               [12]  360 	dec	r6
      000086 BE FF 01         [24]  361 	cjne	r6,#0xff,00135$
      000089 1F               [12]  362 	dec	r7
      00008A                        363 00135$:
      00008A EC               [12]  364 	mov	a,r4
      00008B 4D               [12]  365 	orl	a,r5
      00008C 60 D4            [24]  366 	jz	00108$
                                    367 ;	main.c:19: }
      00008E 80 F1            [24]  368 	sjmp	00104$
                                    369 	.area CSEG    (CODE)
                                    370 	.area CONST   (CODE)
                                    371 	.area XINIT   (CODE)
