      ...
      000073 22               [24]  385 	ret
                                    ...
                                    388 ;------------------------------------------------------------
                                    389 ;i                         Allocated to registers r7 
                                    390 ;------------------------------------------------------------
                                    391 ;	waterlight.c:4: void main(){
                                    392 ;	-----------------------------------------
                                    393 ;	 function main
                                    394 ;	-----------------------------------------
      000074                        395 _main:
                                    396 ;	waterlight.c:7: for(i=0; i<8; i++){
      000074                        397 00109$:
      000074 7F 00            [12]  398 	mov	r7,#0x00
      000076                        399 00105$:
                                    400 ;	waterlight.c:8: LED_PORT=~(0x01<<i);
      000076 8F 06            [24]  401 	mov	ar6,r7
      000078 8E F0            [24]  402 	mov	b,r6
      00007A 05 F0            [12]  403 	inc	b
      00007C 74 01            [12]  404 	mov	a,#0x01
      00007E 80 02            [24]  405 	sjmp	00124$
      000080                        406 00122$:
      000080 25 E0            [12]  407 	add	a,acc
      000082                        408 00124$:
      000082 D5 F0 FB         [24]  409 	djnz	b,00122$
      000085 F4               [12]  410 	cpl	a
      000086 F5 A0            [12]  411 	mov	_P2,a
                                    412 ;	waterlight.c:9: delay_10us(50000);
      000088 90 C3 50         [24]  413 	mov	dptr,#0xc350
      00008B C0 07            [24]  414 	push	ar7
      00008D 12 00 62         [24]  415 	lcall	_delay_10us
      000090 D0 07            [24]  416 	pop	ar7
                                    417 ;	waterlight.c:7: for(i=0; i<8; i++){
      000092 0F               [12]  418 	inc	r7
      000093 BF 08 00         [24]  419 	cjne	r7,#0x08,00125$
      000096                        420 00125$:
      000096 40 DE            [24]  421 	jc	00105$
                                    422 ;	waterlight.c:12: }
      000098 80 DA            [24]  423 	sjmp	00109$
                                    424 	.area CSEG    (CODE)
                                    425 	.area CONST   (CODE)
                                    426 	.area XINIT   (CODE)
