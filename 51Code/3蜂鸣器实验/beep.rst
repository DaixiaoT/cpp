      ...
      000003 02 00 74         [24]  347 	ljmp	_main
                                    ...
                                    357 ;------------------------------------------------------------
                                    358 ;	../common.h:5: void delay_10us(u16 ten_us){
                                    359 ;	-----------------------------------------
                                    360 ;	 function delay_10us
                                    361 ;	-----------------------------------------
      000062                        362 _delay_10us:
                           000007   363 	ar7 = 0x07
                           000006   364 	ar6 = 0x06
                           000005   365 	ar5 = 0x05
                           000004   366 	ar4 = 0x04
      ...
      000073 22               [24]  385 	ret
                                    ...
                                    388 ;------------------------------------------------------------
                                    389 ;i                         Allocated to registers r6 r7 
                                    390 ;------------------------------------------------------------
                                    391 ;	beep.c:3: void main(){
                                    392 ;	-----------------------------------------
                                    393 ;	 function main
                                    394 ;	-----------------------------------------
      000074                        395 _main:
                                    396 ;	beep.c:5: while (i--)
      000074 7E 14            [12]  397 	mov	r6,#0x14
      000076 7F 00            [12]  398 	mov	r7,#0x00
      000078                        399 00101$:
      000078 8E 04            [24]  400 	mov	ar4,r6
      00007A 8F 05            [24]  401 	mov	ar5,r7
      00007C 1E               [12]  402 	dec	r6
      00007D BE FF 01         [24]  403 	cjne	r6,#0xff,00115$
      000080 1F               [12]  404 	dec	r7
      000081                        405 00115$:
      000081 EC               [12]  406 	mov	a,r4
      000082 4D               [12]  407 	orl	a,r5
      000083 60 1A            [24]  408 	jz	00103$
                                    409 ;	beep.c:7: BEEP = 1;
                                    410 ;	assignBit
      000085 D2 A5            [12]  411 	setb	_P2_5
                                    412 ;	beep.c:8: delay_10us(190);
      000087 90 00 BE         [24]  413 	mov	dptr,#0x00be
      00008A C0 07            [24]  414 	push	ar7
      00008C C0 06            [24]  415 	push	ar6
      00008E 12 00 62         [24]  416 	lcall	_delay_10us
                                    417 ;	beep.c:9: BEEP=0;
                                    418 ;	assignBit
      000091 C2 A5            [12]  419 	clr	_P2_5
                                    420 ;	beep.c:10: delay_10us(10);
      000093 90 00 0A         [24]  421 	mov	dptr,#0x000a
      000096 12 00 62         [24]  422 	lcall	_delay_10us
      000099 D0 06            [24]  423 	pop	ar6
      00009B D0 07            [24]  424 	pop	ar7
      00009D 80 D9            [24]  425 	sjmp	00101$
      00009F                        426 00103$:
                                    427 ;	beep.c:13: BEEP=0;
                                    428 ;	assignBit
      00009F C2 A5            [12]  429 	clr	_P2_5
                                    430 ;	beep.c:15: }
      0000A1 22               [24]  431 	ret
                                    432 	.area CSEG    (CODE)
                                    433 	.area CONST   (CODE)
                                    434 	.area XINIT   (CODE)
